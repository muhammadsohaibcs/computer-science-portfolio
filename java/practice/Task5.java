...
public class Task5 {
    ...
    public static void add(){
        ...
        arr[0] = sohaib.nextLine(); 
        System.out.print("Email : ");
        arr[1] = sohaib.nextLine();
        System.out.print("Phone : ");
        arr[2] = sohaib.nextLine();
        System.out.print("Notes : ");
        arr[3] = sohaib.nextLine();
        Array.add(arr);
    ...
    public static void searchName(){
        ...
        for (int i = 0; i < Array.size(); i++) {
            if ((Array.get(i))[0].equals(name)){
                System.out.printf("%-2d  |  %-20s  |  %-20s  |  %-20s  |  %-20s  \n", i+1,Array.get(i)[0],Array.get(i)[1],Array.get(i)[2],Array.get(i)[3]);
                System.out.println("------------------------------------------------------------------------------------- ");
            }      
        }
